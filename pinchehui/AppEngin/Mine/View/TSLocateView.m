...
//    AFHTTPRequestOperationManager *mgr = [AFHTTPRequestOperationManager manager];
  //  [mgr GET:[NSString stringWithFormat:@"http://appwx.25ren.com/api.php?c=member&a=modifymember&userid=51&prvinceID=1&cityID=1&province=河北&city=保定市"] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
//        
