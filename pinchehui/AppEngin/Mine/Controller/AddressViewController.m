...
-(void)rightAction{
    ...
    [mgr GET:[NSString stringWithFormat:@"http://appwx.25ren.com/api.php?c=member&a=modifymember&userid=51&companyaddress=%@",_Address.text] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
