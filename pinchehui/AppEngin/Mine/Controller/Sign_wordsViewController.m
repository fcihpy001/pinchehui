...
@interface Sign_wordsViewController ()

@end

@implementation Sign_wordsViewController
...
-(void)rightAction{
    ...
    [mgr GET:[NSString stringWithFormat:@"http://appwx.25ren.com/api.php?c=member&a=modifymember&userid=51&sign_words=%@",_Sign.text] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
