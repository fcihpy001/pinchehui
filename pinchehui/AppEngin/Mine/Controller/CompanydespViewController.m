...
@interface CompanydespViewController ()

@end

@implementation CompanydespViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)rightAction{
    ...
    [mgr GET:[NSString stringWithFormat:@"http://appwx.25ren.com/api.php?c=member&a=modifymember&userid=51&companydesp=%@",_Company.text] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
