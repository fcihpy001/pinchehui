...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        if (indexPath.row == 0) {
            ...
            [[NSNotificationCenter defaultCenter] postNotificationName:@"pushApplyView" object:nil userInfo:nil];
        }
        else if (indexPath.row == 1)
        {
            ...
            [dict setValue:_groupController forKey:@"groupView"];
            
            [[NSNotificationCenter defaultCenter] postNotificationName:@"pushGroupView" object:nil userInfo:dict];
        ...
        NSMutableDictionary * dict = [[NSMutableDictionary alloc]init];
        [dict setValue:chatVC forKey:@"chatVC"];
        [dict setValue:buddy.username forKey:@"title"];
        
        
        [[NSNotificationCenter defaultCenter]postNotificationName:@"goToContactsView" object:nil userInfo:dict];
